...
public class LoginController {
    ...
    private void redirectByRole(Utilisateur u) {
        try {
            ...
            // Tous les rôles → MainView.fxml (interface commune)
            // On alimente le SessionManager de edu.connection3a36 avec le bon rôle
            ...
            // Appliquer le CSS commun si disponible
