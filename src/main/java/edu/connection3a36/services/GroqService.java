...
public class GroqService {
    ...
    /**
     * Version simplifiée avec schema JSON — envoie le schema dans le prompt.
    ...
    /**
     * Surcharge pour compatibilité avec Object schema (schema ignoré).
     */
    public String sendSimpleJsonMessage(String message, String roleContext, Object schema) throws Exception {
        return sendMessage(message, new ArrayList<>(), roleContext);
    }

    // ── Méthodes fusionnées pour la gestion de projets ────────────────────────
